...
public class SignUpDoctorPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        statue.add(jRadioButton1);
        getContentPane().add(jRadioButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1090, 400, 30, 30));

        statue.add(jRadioButton2);
        getContentPane().add(jRadioButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(1220, 400, 30, 30));

        statue.add(jRadioButton3);
        getContentPane().add(jRadioButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(1360, 400, 30, 30));

        statue.add(jRadioButton4);
        getContentPane().add(jRadioButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(960, 400, 30, 30));
