...
public class UIDeneme extends javax.swing.JFrame {
    ...
    private void logIn_section_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_logIn_section_buttonActionPerformed
        ...
        if (doctorLogin.isSelected()){
            ...
            try{
            String sql = "Select rowid,password from doctors where email = ?";
        ...
        setVisible(false);
            ...
            try{
            String sql = "Select  rowid,password  from patient where email = ?";
            ps = con.prepareStatement(sql);
            ps.setString(1, emailString);
        ...
        setVisible(false);
            ...
            try{
            String sql = "Select  rowid,password  from clinics where email = ?";
            ps = con.prepareStatement(sql);
            ps.setString(1, emailString);
            ...
            if (equal == true){
            JFrame frame = new MainMenuClinic(id);
            frame.setVisible(true);
            setVisible(false);
            }
            else{
